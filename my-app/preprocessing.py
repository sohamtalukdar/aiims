...
ACCESS_TOKEN = "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"
...
def save_features_to_csv(feature_data, csv_file):
    # Check for NaN or empty values in feature_data
    if any(
        value is None or
...
def process_single_file(audio_file, output_csv):
    ...
    # Extract features for each dominant segment and save to CSV
...
def main(audio_file_path, output_csv_file):
    process_single_file(audio_file_path, output_csv_file)
    print(f"Features have been written to {output_csv_file}")

# Example usage
audio_file_path = "./data/PT061224074814/audio_1733467768610.webm"  # Replace with your audio file path
output_csv_file = "./data/PT061224074814/audio_1733467768610.csv"
main(audio_file_path, output_csv_file)
